...
config = GeneratorConfig(
    generator_name="07_minimal_gradient_background_stock_prompt",
    chat_title="Chat For 07_minimal_gradient_background_stock_prompt.txt",
    prompt_file_name="07_minimal_gradient_background_stock_prompt.txt"
)
