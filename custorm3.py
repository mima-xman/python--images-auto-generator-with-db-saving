...
config = GeneratorConfig(
    generator_name="03_teamwork_collaboration_stock_prompt",
    chat_title="Chat For 03_teamwork_collaboration_stock_prompt.txt",
    prompt_file_name="03_teamwork_collaboration_stock_prompt.txt"
)
