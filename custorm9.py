...
config = GeneratorConfig(
    generator_name="09_abstract_3d_shapes_renders_stock_prompt",
    chat_title="Chat For 09_abstract_3d_shapes_renders_stock_prompt.txt",
    prompt_file_name="09_abstract_3d_shapes_renders_stock_prompt.txt"
)
